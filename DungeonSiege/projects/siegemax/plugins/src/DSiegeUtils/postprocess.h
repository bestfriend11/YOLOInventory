...
public:
	...
	// Read in mesh from a max INODE
	bool Read( const char* pData );
	...
	std::vector< gpstring >			m_Textures;
...
public:
	...
	bool Write( InMesh& inMesh, FileSys::File& expFile, DWORD& checksum );
...
public:
	...
	bool Write( FileSys::File& expFile, DWORD& checksum );
...
private:
	...
	void WriteBSPNodeToFile( FileSys::File& expFile, BSPNode* pNode, DWORD& checksum );
...
public:
	...
	bool OrgAndCalcInfo( FileSys::File& expFile, const std::vector<char>& pData );
