...
#if !defined(BLIND_CALLBACK_H)
/* ========================================================================
   Header File: blind_callback.h
   Description: Rich Hickey's blind callback templates
   ======================================================================== */
...
// 1/13/00 Scott Bilas
// Added member templates to get rid of dummy functor* 0 first argument in
//  calls to makeFunctor.
// Made comparisons optional to speed up functor creation.
...
//#define RHCB_ALLOW_COMPARISONS		// uncomment to allow comparisons of functors
...
// $ not currently used - no makeFunctor will generate one (can't see the need yet)
...
makeFunctor(CLASS& c, MEMFUNC mf)
	{
...
////////////////////////////////////////////////////////////////
	...
	template <class FUNC> CBFunctorBase(const CBFunctionTranslatorX <FUNC> & t)
		{
			func = PFunc(t.func);
		}
	template <class CLASS, class MEMFUNC> CBFunctorBase( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		{
			gpassert(sizeof(MEMFUNC) <= MEM_FUNC_SIZE);
			callee = t.cls;
			memcpy(memFunc, &t.mfunc, sizeof(MEMFUNC));
		}
	template <class MEMFUNC> CBFunctorBase( const CBMemberOf1stArgTranslatorX <MEMFUNC> & t )
		{
			gpassert(sizeof(MEMFUNC) <= MEM_FUNC_SIZE);
			memcpy(memFunc, &t.mfunc, sizeof(MEMFUNC));
		}
...
public:
	...
	template <class FUNC> CBFunctor0(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator0 <FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor0( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator0 <CLASS, MEMFUNC>::thunk)  {}
	void operator()()const
		{
		thunk(*this);
		}
...
public:
	...
	template <class FUNC> CBFunctor0wRet(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator0wRet <RT, FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor0wRet( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBFunctionTranslator0wRet <RT, CLASS, MEMFUNC>::thunk)  {}
	RT operator()()const
		{
...
public:
	...
	template <class FUNC> CBFunctor1(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator1 <P1, FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor1( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator1 <P1, CLASS, MEMFUNC>::thunk)  {}
	template <class MEMFUNC> CBFunctor1( const CBMemberOf1stArgTranslatorX <MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberOf1stArgTranslator1 <P1, MEMFUNC>::thunk)  {}
...
public:
	...
	template <class FUNC> CBFunctor1wRet(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator1wRet <P1, RT, FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor1wRet( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator1wRet <P1, RT, CLASS, MEMFUNC>::thunk)  {}
	template <class MEMFUNC> CBFunctor1wRet( const CBMemberOf1stArgTranslatorX <MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberOf1stArgTranslator1wRet <P1, RT, MEMFUNC>::thunk)  {}
...
public:
	...
	template <class FUNC> CBFunctor2(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator2 <P1, P2, FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor2( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator2 <P1, P2, CLASS, MEMFUNC>::thunk)  {}
	template <class MEMFUNC> CBFunctor2( const CBMemberOf1stArgTranslatorX <MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberOf1stArgTranslator2 <P1, P2, MEMFUNC>::thunk)  {}
...
public:
	...
	template <class FUNC> CBFunctor2wRet(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator2wRet <P1, P2, RT, FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor2wRet( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator2wRet <P1, P2, RT, CLASS, MEMFUNC>::thunk)  {}
	template <class MEMFUNC> CBFunctor2wRet( const CBMemberOf1stArgTranslatorX <MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberOf1stArgTranslator2wRet <P1, P2, RT, MEMFUNC>::thunk)  {}
...
public:
	...
	template <class FUNC> CBFunctor3(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator3 <P1, P2, P3, FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor3( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator3 <P1, P2, P3, CLASS, MEMFUNC>::thunk)  {}
	template <class MEMFUNC> CBFunctor3( const CBMemberOf1stArgTranslatorX <MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberOf1stArgTranslator3 <P1, P2, P3, MEMFUNC>::thunk)  {}
...
public:
	...
	template <class FUNC> CBFunctor3wRet(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator3wRet <P1, P2, P3, RT, FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor3wRet( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator3wRet <P1, P2, P3, RT, CLASS, MEMFUNC>::thunk)  {}
	template <class MEMFUNC> CBFunctor3wRet( const CBMemberOf1stArgTranslatorX <MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberOf1stArgTranslator3wRet <P1, P2, P3, RT, MEMFUNC>::thunk)  {}
...
public:
	...
	template <class FUNC> CBFunctor4(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator4 <P1, P2, P3, P4, FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor4( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator4 <P1, P2, P3, P4, CLASS, MEMFUNC>::thunk)  {}
	template <class MEMFUNC> CBFunctor4( const CBMemberOf1stArgTranslatorX <MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberOf1stArgTranslator4 <P1, P2, P3, P4, MEMFUNC>::thunk)  {}
...
public:
	...
	template <class FUNC> CBFunctor4wRet(const CBFunctionTranslatorX <FUNC> & t)
		: CBFunctorBase(t), thunk(CBFunctionTranslator4wRet <P1, P2, P3, P4, RT, FUNC>::thunk)  {}
	template <class CLASS, class MEMFUNC> CBFunctor4wRet( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator4wRet <P1, P2, P3, P4, RT, CLASS, MEMFUNC>::thunk)  {}
	template <class MEMFUNC> CBFunctor4wRet( const CBMemberOf1stArgTranslatorX <MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberOf1stArgTranslator4wRet <P1, P2, P3, P4, RT, MEMFUNC>::thunk)  {}
