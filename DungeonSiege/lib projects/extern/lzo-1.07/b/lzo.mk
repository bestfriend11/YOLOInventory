#
# Common stuff for all Makefiles - requires GNU make 3.77 or better
#
...
ifeq ($(strip $(COMSPEC)),)
COMPILE_C = $(CC) $(CFLAGS) $($(<ba)_CFLAGS) -c $<
else
COMPILE_C = $(CC) $(CFLAGS) $($(<ba)_CFLAGS) -c $(<bs)
endif
endif


ltest_c_CFLAGS += -DNO_ZLIB_H
align_c_CFLAGS += -Isrc
...
ltest$(exe) : %$(exe) : %$(o) $(liblzo) $(ltest_LDADD)
	$(LZO_LINK) $(ltest_LDFLAGS) $(ltest_LIBS)
...
clean:
	-rm -f *.o *.obj *.err core $(liblzo) ltest$(exe) $(test_PROGRAMS)
