...
#ifndef __BLINDCALLBACK_H
#define __BLINDCALLBACK_H
...
public:
	...
	template <class CLASS, class MEMFUNC> CBFunctor0wRet( const CBMemberTranslatorX <CLASS, MEMFUNC> & t )
		: CBFunctorBase(t), thunk(CBMemberTranslator0wRet <RT, CLASS, MEMFUNC>::thunk)  {}
	RT operator()()const
		{
