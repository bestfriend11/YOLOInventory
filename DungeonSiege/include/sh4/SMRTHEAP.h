...
#elif defined(__hpux)
   SMPSMP predefined constant indicated MT on HP-UX???
...
MEM_ENTRY1 void MEM_ENTRY shi_freeThreadPools(void);

#else /* MEM_MT */
MEM_ENTRY4 MEM_POOL MemDefaultPool;
MEM_POOL MEM_ENTRY MemInitDefaultPool(void);
MEM_ENTRY MemFreeDefaultPool(void);
#endif /* MEM_MT */
