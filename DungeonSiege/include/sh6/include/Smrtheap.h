...
#define SHI_MAJOR_VERSION 6
#define SHI_MINOR_VERSION 0
#define SHI_UPDATE_LEVEL 1
...
/* Process heap usage */
MEM_ENTRY1 void MEM_ENTRY MemProcessSetGrowIncrement(unsigned long size);
MEM_ENTRY1 void MEM_ENTRY MemProcessSetFreeBytes(unsigned long size);
MEM_ENTRY1 void MEM_ENTRY MemProcessSetLargeBlockThreshold(unsigned long size);

#if defined(_AIX)
MEM_BOOL MemPatchProcess(void);
#endif /* _AIX */
...
MEM_ENTRY1 unsigned long MEM_ENTRY MemPoolSetGrowIncrement(MEM_POOL,
	unsigned long);
MEM_ENTRY1 unsigned long MEM_ENTRY MemPoolSetFreeBytes(MEM_POOL, unsigned long);
MEM_ENTRY1 MEM_BOOL MEM_ENTRY MemPoolSetSmallBlockAllocator(MEM_POOL, MEM_SMALL_BLOCK_ALLOCATOR);
MEM_ENTRY1 void MEM_ENTRY MemPoolSetHighThreads(MEM_POOL, MEM_BOOL);
...
void MEM_FAR *MemAllocAligned(MEM_POOL, unsigned long,
