...
class YOLOINVENTORYLEGACYBRIDGE_API UYIUI_NameDesc : public UYIStackEntry_UI
{
	GENERATED_BODY()
public:
...
UCLASS(BlueprintType, EditInlineNew)
class YOLOINVENTORYLEGACYBRIDGE_API UYIAbility_GrantAbility : public UYIStackEntry_Ability
{
	GENERATED_BODY()
public:
...
UCLASS(BlueprintType, EditInlineNew)
class YOLOINVENTORYLEGACYBRIDGE_API UYIUI_AudioVisual : public UYIStackEntry_UI
{
	GENERATED_BODY()
public:
...
UCLASS(BlueprintType, EditInlineNew)
class YOLOINVENTORYLEGACYBRIDGE_API UYIAbility_Physics : public UYIStackEntry_Ability
{
	GENERATED_BODY()
public:
...
UCLASS(BlueprintType, EditInlineNew)
class YOLOINVENTORYLEGACYBRIDGE_API UYIUpgrade_Path : public UYIStackEntry_Upgrade
{
	GENERATED_BODY()
public:
...
UCLASS(BlueprintType, EditInlineNew)
class YOLOINVENTORYLEGACYBRIDGE_API UYIEconomy_Market : public UYIStackEntry_Economy
{
	GENERATED_BODY()
public:
...
UCLASS(BlueprintType, EditInlineNew)
class YOLOINVENTORYLEGACYBRIDGE_API UYIEconomy_DurabilityRules : public UYIStackEntry_Economy
{
	GENERATED_BODY()
public:
