...
struct YOLOINVENTORYLEGACYBRIDGE_API FYIInventoryGameplaySetupOptions
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYLEGACYBRIDGE_API FYIInventoryGameplaySetupResult
{
	GENERATED_BODY()
...
UCLASS()
class YOLOINVENTORYLEGACYBRIDGE_API UYIInventoryGameplaySetupLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	/**
