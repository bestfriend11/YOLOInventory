...
struct YOLOINVENTORYLEGACYBRIDGE_API FYICapabilitySpec
{
	GENERATED_BODY()
};

USTRUCT(BlueprintType)
struct YOLOINVENTORYLEGACYBRIDGE_API FYICap_UI : public FYICapabilitySpec
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYLEGACYBRIDGE_API FYICap_Equip : public FYICapabilitySpec
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYLEGACYBRIDGE_API FYICap_Durability : public FYICapabilitySpec
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYLEGACYBRIDGE_API FYICap_Economy : public FYICapabilitySpec
{
	GENERATED_BODY()
