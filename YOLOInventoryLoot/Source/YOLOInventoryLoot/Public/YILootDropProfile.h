...
struct YOLOINVENTORYLOOT_API FYILootGuaranteedDropEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYLOOT_API FYILootDropContext
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYLOOT_API FYILootDropResult
{
	GENERATED_BODY()
...
class YOLOINVENTORYLOOT_API UYILootDropProfile : public UDataAsset
{
	GENERATED_BODY()
public:
