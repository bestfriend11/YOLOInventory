...
struct YOLOINVENTORYEQUIPMENT_API FYIEquippedItemEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYEQUIPMENT_API FYIEquipmentSlotDefinition
{
	GENERATED_BODY()
...
class YOLOINVENTORYEQUIPMENT_API UYIEquipmentComponent : public UActorComponent
{
	GENERATED_BODY()
public:
