...
class YOLOINVENTORYEQUIPMENT_API UYIInventoryPersistenceProviderBase : public UObject
{
	GENERATED_BODY()
public:
...
class YOLOINVENTORYEQUIPMENT_API UYISaveGameInventoryPersistenceProvider : public UYIInventoryPersistenceProviderBase
{
	GENERATED_BODY()
public:
