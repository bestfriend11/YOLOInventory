...
struct YOLOINVENTORYEQUIPMENT_API FYISavedBagSnapshot
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct YOLOINVENTORYEQUIPMENT_API FYIPartyMemberEntry
{
	GENERATED_BODY()
...
class YOLOINVENTORYEQUIPMENT_API UYIPlayerInventoryStateComponent : public UActorComponent
{
	GENERATED_BODY()
public:
