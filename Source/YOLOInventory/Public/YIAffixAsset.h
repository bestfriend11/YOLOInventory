...
struct YOLOINVENTORY_API FYIAffixDefinitionFragmentBase
{
	GENERATED_BODY()
};

USTRUCT(BlueprintType)
struct YOLOINVENTORY_API FYIStaticAffixDefinitionFragment : public FYIAffixDefinitionFragmentBase
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORY_API FYIAffixResolvedDefinitionData
{
	GENERATED_BODY()
