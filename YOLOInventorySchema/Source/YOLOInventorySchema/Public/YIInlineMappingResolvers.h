...
YOLOINVENTORYSCHEMA_API FName YIGetResolvedTargetFieldName(const FYIFieldMapping& Mapping);

/** Resolve a source row field by authored name and return property + data pointer. */
YOLOINVENTORYSCHEMA_API bool YIResolveMappingSource(
...
YOLOINVENTORYSCHEMA_API bool YIResolveMappingTarget(
