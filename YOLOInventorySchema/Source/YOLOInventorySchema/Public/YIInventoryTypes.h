...
struct YOLOINVENTORYSCHEMA_API FYIItemStat
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYSCHEMA_API FYIItemRequirement
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYSCHEMA_API FYIItemAbility
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYSCHEMA_API FYIItemEffect
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYSCHEMA_API FYIEvolutionState
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct YOLOINVENTORYSCHEMA_API FYIItemVariant
{
    GENERATED_BODY()
...
// Rarity style
USTRUCT(BlueprintType)
struct YOLOINVENTORYSCHEMA_API FYOLORarityStyle
{
    GENERATED_BODY()
